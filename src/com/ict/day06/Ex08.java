...
public class Ex08 {
	public static void main(String[] args) {
		...
		// 입력된 문자 열을 현재 문자 열과 합친다. ("문자열" + "문자열"과 같은 결과)
		String s1 = "대한민국";
		...
		String s5 = "elseks123@gmail.com";
		 boolean res = s5.contains("@");
		// boolean res = s5.contains(''@'); 			//char 는 사용 불가
		...
		//			입력된 문자열과 현재 문자열이 같으면 true, 다르면 false (대소문자 구별0)
		
		//5. 		equalsIgnoreCase(String anotherString) : boolean
		//			입력된 문자가 현재 문자와 같으면 true, 다르면 false (대소문자 구별x)
		...
		//			보통 입/출력 할 때 사용한다. (대소문자, 숫자 가능, 영어 이외의 글자는 안됨)
		//			나중에 [] 배열을 배운 후에 한다.
		
		//8.		indexOf(int ch), 또는 	indexOf(String str) : int
		...
		//		지금은 두번째줄은 replace(String oldString, String newString) : String   으로 이해 해도 됨.
		...
		//		해당 문자열의 앞, 뒤, 공백 제거, 중간 공백은 제거하지 않는다.
			String t9 = "  java 자바 JAVA  ";
			 ...
			 System.out.println(t9.length()); 								// 문자열의 길이 구하는 법 length() : 16
			 System.out.println(t10);
			 System.out.println(t10.length());								// : 12
			 
			 //20. startWith(String prefix) : boolean  => 주어진 문자로 시작하는지 검색
			 //	 startWith(String prefix, int toffset) : boolean  => 주어진 문자열로 시작하는지 검색
			 //																	toffset => 시작 위치\
			 //		endWith(String suffix) : boolean  => 주어진 문자열로 끝나는지 검색
			 
			 boolean b1 = t10.startsWith("java");
			 ...
			 //  		어떤 기본 자료형이든지 String 으로 변경시킴 ( 기본자료형 + "")
			 boolean bo1 = true;
			 char ch1 = 'c';
			 int num1 = 34 ;
			 long num2 = 37L;
			 ...
			 /// 자료형 +1	  = 실제로 덧셈을 한다.
			 // System.out.println(bo1+1);				//boolean형에 +1 하면 오류
			 ...
			 System.out.println(num4+1);
			  ...
			  System.out.println(String.valueOf(bo1)+1);						//String으로 결과나옴
			  ...
			  System.out.println(String.valueOf(bo1)+"1");						//위의 결과와 같지만
			  System.out.println(String.valueOf(ch1)+"1");							
			  System.out.println(String.valueOf(num1)+"1");
			  System.out.println(String.valueOf(num2)+"1");
			  System.out.println(String.valueOf(num3)+"1");
			  ...
			  // 22-1. "true", "false" 문자열을 기본 자료형인 boolean 형으로 변경 : Boolean.parseBoolean(String) ;
			 ...
			 // System.out.println(msg2+1);
			  ...
			  // 22-2. "10", "124" 문자열을 기본 자료형 int 형으로 변경 : Intger.parseInt(String s) ;
			  msg = "124";
			  int msg3 = Integer.parseInt(msg);
			  System.out.println(msg+10); 			//12410
			  System.out.println(msg3+10);			//134
			  
			  // 22-3. 문자열을 기본 자료형인 long형으로 변경 : Long.parseLong() ;
			  // "숫자" => ok, 		"숫자L" => error
			  msg = "12345612312";
